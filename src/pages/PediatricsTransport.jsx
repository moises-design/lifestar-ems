import { FaPhone, FaCheckCircle, FaStar, FaHeart, FaShieldAlt, FaSmile } from 'react-icons/fa'
import './ServicePage.css'
import './PediatricsTransport.css'

const features = [
  { icon: '😊', title: 'Kid-Friendly Staff', desc: 'Our trained team knows how to make children feel safe, calm, and comfortable during transport.' },
  { icon: '🛡️', title: 'Safe & Secure', desc: 'Specially equipped vehicles with pediatric safety features for children of all ages and sizes.' },
  { icon: '💙', title: 'Family Centered', desc: 'Parents or guardians are always welcome to ride along with their child.' },
  { icon: '📋', title: 'Care Coordinated', desc: 'We work with your child\'s therapy team and healthcare providers for seamless scheduling.' },
]
...
const insurance = [
  'Driscoll Children\'s Healthplan', 'Healthspring', 'Superior Healthplan',
  'Medicaid CSHCN', 'United Healthcare', 'Molina Healthcare',
  'Ambetter', 'Private Insurance',
]
    ...
    <div className="service-page peds-page">
      ...
      <section className="sp-hero peds-hero">
        ...
        <div className="peds-stars">
          {[...Array(20)].map((_, i) => (
            <div key={i} className="peds-star" style={{
        ...
        <div className="container sp-hero-inner">
          ...
          <p className="sp-desc">
            We specialize in non-emergency medical transportation for children of all ages.
            From therapy centers to specialist visits — our friendly, trained staff makes
            every ride comfortable, safe, and stress-free for your child and family.
          </p>
          <div className="sp-actions">
            <a href="tel:9566606543" className="sp-btn-primary peds-btn">
      ...
      <section className="sp-offer">
        <div className="container">
          <div className="sp-offer-grid">
            <div>
              <span className="section-label">Our Commitment to Families</span>
              ...
              <ul className="sp-checklist">
                {[
                  ...
                  'On-time pickup — every single appointment',
                  'Direct coordination with therapy centers',
                  'Compassionate, patient, child-friendly staff',
            ...
            <div className="sp-contact-box peds-contact-box">
              ...
              <p>Let's talk about your child's transportation needs. We'll handle insurance verification and scheduling.</p>
              <a href="tel:9566606543" className="sp-btn-primary peds-btn" style={{ display: 'flex', justifyContent: 'center', marginBottom: 16 }}>
      ...
      <section className="sp-insurance">
        <div className="container">
          ...
          <div className="sp-ins-grid">
            {insurance.map((ins, i) => (
              <div className="sp-ins-badge peds-ins-badge" key={i}>{ins}</div>
            ))}
          </div>
      ...
      <section className="sp-cta peds-cta-section">
        <div className="container">
          ...
          <a href="tel:9566606543" className="sp-btn-primary peds-btn large">
