    ...
    <div className="service-page therapy-page">
      <section className="sp-hero therapy-hero">
        ...
        <div className="container sp-hero-inner">
          ...
          <p className="sp-desc">
            Whether it's weekly physical therapy, cancer treatments, or wound care —
            Life Star EMS provides reliable, on-time transportation so you never miss
            a critical appointment. Professional, compassionate staff every ride.
          </p>
      ...
      <section className="sp-insurance">
        <div className="container">
          ...
          <div className="sp-ins-grid">
            {insurance.map((ins, i) => <div className="sp-ins-badge" key={i}>{ins}</div>)}
          </div>
      ...
      <section className="sp-cta">
        <div className="container">
          ...
          <p>Call us today — we'll handle scheduling, insurance, and everything in between.</p>
